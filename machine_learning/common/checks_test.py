...
class ChecksTests(unittest.TestCase):
    ...
    def test_check_condition_false(self):
        ...
        self.assertEqual(r"('\x1b[2m\x1b[34mTHE PREFIX\x1b[0m: \x1b[31mFail\x1b[0m',){}", self.printed)
    
    def test_check_condition_true(self):
        with patch('builtins.print', new=self.make_fake_print()):
            checks.check_condition(True, 'THE PREFIX')
            
        self.assertEqual(r"('\x1b[2m\x1b[34mTHE PREFIX\x1b[0m: \x1b[32mPass\x1b[0m',){}", self.printed)
